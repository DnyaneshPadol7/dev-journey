...
$getin="select * from sales_invoices order by invoice_no desc";
...
<body>
  ...
  <div class="container-fluid">
    <form id="invoiceForm" action="./sales.php" method="post">
      <div class="row">
        <!-- Invoice header  -->
        <div class="col-2  ">
          <label for="customerSelect">Customer:</label>
          <select class="customer" id="customerSelect" name="customer_id" required>
  ...
  <div class="justify-content-center saveb">
    <button type="submit" form="invoiceForm" class="position-fixed bottom-0 end-0  mb-0 save-btn">Save & Print Sales</button>
  ...
  input.addEventListener('input', () => {
    ...
    .then(response => {
        if (response.success) {
            ...
            window.location.href = `../Bill/saleDetail.php?invoice_no=${response.invoice_no}&invoice_id=${response.invoice_id}`;
        } else {
