...
file_put_contents("debug_payment.txt", $raw);  // request body ko ek file me save karo
...
// Insert payment
$sql = "INSERT INTO purchase_payment (invoice_id,date, amount_paid, pay_method, reference,note)
