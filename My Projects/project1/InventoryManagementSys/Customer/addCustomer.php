...
if (isset($_POST['submit'])) {
    ...
    if (empty($name) || empty($phone) || empty($email) || empty($address)) {
        ...
        // 3️⃣ Insert query
        $query = "INSERT INTO customers(customer_name, mobileNo, email, address) 
        ...
        if ($result) {
            ...
            error_log("Failed to add customer: " . mysqli_error($conn));
            echo "<p style='color:red; text-align:center;'>❌ Failed to add customer. Please try again.</p>";
        }
    }
}
?>
